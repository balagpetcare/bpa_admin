...
export const communityMembershipApi = {
  ...
  updateTier: (id: string, data: Partial<CommunityMembershipTier>) =>
    api.put<CommunityMembershipTier>(`/admin/community-membership/tiers/${id}`, data),
  ...
  updatePurchaseStatus: (id: string, status: string) => api.put<any>(`/admin/community-membership/purchases/${id}/status`, { status }),
  getPurchaseCard: (id: string) => api.get<any>(`/admin/community-membership/purchases/${id}/card`),
  settlePurchase: (id: string, note?: string) => api.post<any>(`/admin/community-membership/purchases/${id}/settle`, { note }),
  rejectPurchase: (id: string, reason?: string) => api.post<any>(`/admin/community-membership/purchases/${id}/reject`, { reason }),
  regeneratePdf: (id: string) => api.post<any>(`/admin/community-membership/purchases/${id}/regenerate-pdf`),
  ...
  settleUpgrade: (id: string, note?: string) => api.post<any>(`/admin/community-membership/upgrades/${id}/settle`, { note }),
  ...
  updateDocument: (id: string, data: any) => api.put<any>(`/admin/community-membership/documents/${id}`, data),
