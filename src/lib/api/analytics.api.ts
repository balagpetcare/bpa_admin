...
export const analyticsApi = {
  overview: (params?: AnalyticsParams) =>
    api.get<AnalyticsOverview>('/admin/analytics/overview', params as any),

  traffic: (params?: AnalyticsParams) =>
    api.get<TrafficAnalyticsData>('/admin/analytics/traffic', params as any),

  revenue: (params?: AnalyticsParams) =>
    api.get<RevenueAnalytics>('/admin/analytics/revenue', params as any),

  membership: (params?: AnalyticsParams) =>
    api.get<MembershipAnalytics>('/admin/analytics/membership', params as any),

  campaigns: (params?: AnalyticsParams) =>
    api.get<CampaignAnalyticsData>('/admin/analytics/campaigns', params as any),

  donations: (params?: AnalyticsParams) =>
    api.get<DonationAnalyticsData>('/admin/analytics/donations', params as any),

  petCensus: (params?: AnalyticsParams) =>
    api.get<PetCensusAnalyticsData>('/admin/analytics/pet-census', params as any),

  support: (params?: AnalyticsParams) =>
    api.get<SupportAnalyticsData>('/admin/analytics/support', params as any),

  conversions: (params?: AnalyticsParams) =>
    api.get<ConversionFunnelData>('/admin/analytics/conversions', params as any),

  live: () =>
    api.get<LiveAnalyticsData>('/admin/analytics/live'),

  summary: () =>
    api.get<any>('/admin/analytics/summary'),

  forms: (params?: AnalyticsParams) =>
    api.get<any>('/admin/analytics/forms', params as any),
}
