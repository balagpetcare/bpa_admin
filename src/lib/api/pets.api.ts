...
export const petsApi = {
  ...
  listOwners: (params?: PetOwnerListParams) =>
    api.get<PaginatedResult<PetOwner>>('/admin/pets/owners', params as Record<string, string | number | boolean | undefined>),
  ...
  // Pets
  list: (params?: PetListParams) => api.get<PaginatedResult<Pet>>('/admin/pets', params as Record<string, string | number | boolean | undefined>),
