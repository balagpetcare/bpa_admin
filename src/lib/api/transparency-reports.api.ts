...
export const transparencyReportsApi = {
  ...
  create: (data: TransparencyReportPayload) => api.post<TransparencyReport>('/admin/transparency-reports', data),
  update: (id: string, data: TransparencyReportUpdatePayload) => api.patch<TransparencyReport>(`/admin/transparency-reports/${id}`, data),
  remove: (id: string) => api.delete<void>(`/admin/transparency-reports/${id}`),
  publish: (id: string) => api.patch<TransparencyReport>(`/admin/transparency-reports/${id}/publish`, {}),
  unpublish: (id: string) => api.patch<TransparencyReport>(`/admin/transparency-reports/${id}/unpublish`, {}),
}
