import { api } from '../api'
import type { Country, Division, District, CityCorporation, Zone, Venue, PublicLocationCountry, LocationNode, LocationNodeType } from '@/types/bpa.types'
...
export const locationTreeApi = {
  ...
  search: (q: string, type?: LocationNodeType) =>
    api.get<LocationNode[]>('/admin/location-tree/search', { q, ...(type ? { type } : {}) }),
