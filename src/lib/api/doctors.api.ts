...
export const doctorsApi = {
  list: (params?: DoctorListParams) => api.getPaginated<Doctor>('/admin/doctors', params as Record<string, string | number | boolean | undefined>),
  ...
  update: (
    id: string,
    dto: Partial<{ name: string; email: string; phone: string; licenseNumber: string; specialization: string; bio: string; isActive: boolean }>,
