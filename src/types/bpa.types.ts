...
export interface CampaignListItem {
  ...
  basePriceBdt: string; maxPetsPerBooking: number; isFeatured: boolean; createdAt: string; updatedAt: string
  createdBy: { id: string; name: string; email: string }
  coverImage: { id: string; url: string; altText: string | null } | null
  _count: { sessions: number; services: number; doctors: number; volunteers: number }
}
...
export interface CampaignService {
  ...
  priceOverrideBdt: string | null; sortOrder: number; vaccineCatalogId: string | null
...
export type PetCensusPetType = 'cat' | 'dog' | 'bird' | 'other'
