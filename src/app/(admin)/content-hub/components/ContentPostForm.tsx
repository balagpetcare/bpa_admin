...
export default function ContentPostForm({ existing, defaultType }: ContentPostFormProps) {
  ...
  const categoryOptions = categories.map((c) => ({ value: c.id, label: c.nameEn }))
    ...
    <div className="container-fluid py-4">
      <div className="mb-3 d-flex align-items-center gap-2">
        <Button
          variant="light"
          size="sm"
          onClick={() => router.push(defaultType === 'VIDEO' ? '/content-hub/videos' : '/content-hub/community')}
        >
          ← Back
        </Button>
              ...
              <Card.Body>
                ...
                <Form.Group className="mb-3">
                  ...
                  <Form.Control
                    type="text"
                    required
                    {...register('titleBn', { required: true })}
                ...
                <Form.Group className="mb-3">
                  ...
                  <Form.Control
                    ...
                    placeholder="e.g. video-how-to-vaccinate"
                  />
                </Form.Group>
              ...
              <Card className="mb-4">
                ...
                <Card.Body>
                  ...
                  {videoSourceTypeValue === 'youtube' ? (
                    <>
                      <Form.Group className="mb-3">
                        <Form.Label className="fw-semibold">Video URL</Form.Label>
                        <Form.Control
                          type="url"
                          {...register('videoUrl')}
                      ...
                      <Form.Group className="mb-3">
                        ...
                        <Form.Select {...register('videoProvider')}>
                ...
                <Col md={6}>
                  <Form.Group className="mb-3">
                    ...
                    <Form.Control
                      type="text"
                      {...register('ctaUrl')}
                      placeholder="e.g. /community-pet-care/contribute"
                    />
                  </Form.Group>
                </Col>
                <Col md={6}>
                ...
                <Col md={6}>
                  <Form.Group className="mb-3">
                    ...
                    <Form.Control
                      type="text"
                      {...register('ctaLabelEn')}
                      placeholder="e.g. Register Your Pet"
                    />
                  </Form.Group>
                </Col>
                <Col md={6}>
                  <Form.Group className="mb-3">
                    ...
                    <Form.Control
                      type="text"
                      {...register('ctaLabelBn')}
                      placeholder="e.g. রেজিষ্ট্রেশন করুন"
                    />
                  </Form.Group>
                </Col>
              </Row>
