...
export default function SmsLogsContent() {
  ...
  const handleStatus = (v: SmsStatus | '') => {
    setStatus(v)
    setPage(1)
  }
  ...
  return (
    <div className="container-fluid">
      <PageHeader title="SMS Logs" breadcrumbs={[{ label: 'Notifications' }, { label: 'SMS Logs' }]} />
      ...
      <SmsLogDetailsModal log={selected} isOpen={modalOpen} onClose={() => setModalOpen(false)} />
    </div>
  )
}
