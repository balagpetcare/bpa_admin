  ...
  return (
    <Card className="border-0 shadow-sm text-center py-5 my-4">
      <Card.Body className="py-5">
        <div
          className="avatar-lg bg-soft-primary rounded-circle mx-auto mb-4 flex-centered"
          style={{
            width: '80px',
            height: '80px',
            display: 'flex',
        ...
        <p className="text-muted mx-auto mb-4" style={{ maxWidth: '500px' }}>
          The Bangladesh Pet Association Care Fund hasn&apos;t received any donations yet. Setup campaigns, publish purposes, and check the public
          donation page to begin fundraising.
        </p>
        <div className="d-flex justify-content-center gap-3 flex-wrap">
          ...
          <a
            href={`${process.env.NEXT_PUBLIC_SITE_URL || 'https://bpa.org.bd'}/donate`}
            target="_blank"
            rel="noopener noreferrer"
            className="btn btn-soft-secondary d-flex align-items-center gap-2">
