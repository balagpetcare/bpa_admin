...
export default function VaccinationMonitor({ campaignId }: { campaignId: string }) {
  ...
  const fetchFn = useCallback(() => checkinApi.listVaccinationRecords({ campaignId, page, limit: 30 }), [campaignId, page])
  ...
  return (
    <div className="container-fluid">
      <PageHeader
        ...
        breadcrumbs={[{ label: 'Campaigns', href: '/campaigns' }, { label: 'Detail', href: `/campaigns/${campaignId}` }, { label: 'Vaccinations' }]}
      />
