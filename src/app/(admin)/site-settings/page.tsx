                    ...
                    <>
                      <Col md={4}>
                        <Form.Group>
                          ...
                          <Form.Control
                            ...
                            placeholder="Bangladesh Pet Association"
                          />
                        </Form.Group>
                      </Col>
                      <Col md={4}>
                      ...
                      <Col md={6}>
                        <Form.Group>
                          ...
                          <Form.Control
                            ...
                            placeholder="Caring for every pet, every life."
                          />
                        </Form.Group>
                      </Col>
                      <Col md={6}>
                        <Form.Group>
                          ...
                          <Form.Control
                            ...
                            placeholder="Building a Better Future for Pets"
                          />
                        </Form.Group>
                      </Col>
                      <Col md={12}>
                        <Form.Group>
                          ...
                          <Form.Control
                            ...
                            placeholder="https://bangladeshpetassociation.com"
                          />
                        </Form.Group>
                      </Col>
                      ...
                      <Col md={12}>
                        <Form.Group>
                          ...
                          <Form.Control
                            value={f('defaultMetaTitle')}
                            onChange={(e) => set('defaultMetaTitle', e.target.value)}
                            placeholder="Bangladesh Pet Association — Official Site"
                          />
                        </Form.Group>
                      </Col>
                      <Col md={12}>
                        <Form.Group>
                          ...
                          <Form.Control
                            as="textarea"
                            rows={2}
                            value={f('defaultMetaDescription')}
                    ...
                    <>
                      ...
                      <Col md={3}>
                        <Form.Group>
                          ...
                          <Form.Control
                            type="email"
                            value={f('generalEmail')}
                            onChange={(e) => set('generalEmail', e.target.value)}
                            placeholder="info@bpa.org.bd"
                          />
                      ...
                      <Col md={3}>
                        <Form.Group>
                          ...
                          <Form.Control
                            ...
                            placeholder="support@bpa.org.bd"
                          />
                        </Form.Group>
                      </Col>
                      <Col md={3}>
                        <Form.Group>
                          ...
                          <Form.Control
                            ...
                            placeholder="info@bangladeshpetassociation.com"
                          />
                        </Form.Group>
                      </Col>
                      <Col md={3}>
                        <Form.Group>
                          ...
                          <Form.Control
                            type="email"
                            value={f('vaccinationEmail')}
                            onChange={(e) => set('vaccinationEmail', e.target.value)}
                            placeholder="vaccination2026@bangladeshpetassociation.com"
                          />
                        </Form.Group>
                      </Col>
                      ...
                      <Col md={12}>
                        <Form.Group>
                          ...
                          <Form.Control
                            ...
                            placeholder="Sun–Thu: 9 AM – 6 PM, Fri–Sat: Closed"
                          />
                      ...
                      <Col md={12}>
                        <Form.Group>
                          ...
                          <Form.Control
                            ...
                            placeholder="Plot 10, Road 5, Block A, Bashundhara R/A, Dhaka"
                          />
                      ...
                      <Col md={12}>
                        <Form.Group>
                          ...
                          />
                          <Form.Text className="text-muted">Used for &ldquo;View on Google Maps&rdquo; button on contact page.</Form.Text>
                        </Form.Group>
                      </Col>
                      <Col md={12}>
                        <Form.Group>
                          ...
                          <Form.Text className="text-muted">
                            If provided, an interactive embedded map will display on the contact page. Get this from Google Maps → Share → Embed a map
                            → copy the src URL.
                          </Form.Text>
                        </Form.Group>
                      </Col>
                      ...
                      <Col md={12}>
                        <Form.Group>
                          ...
                          <Form.Control
                            ...
                            placeholder="https://facebook.com/bpa"
                          />
                        </Form.Group>
                      </Col>
                      <Col md={12}>
                        <Form.Group>
                          ...
                          <Form.Control
                            ...
                            placeholder="https://youtube.com/@bpa"
                          />
                        </Form.Group>
                      </Col>
                      <Col md={12}>
                        <Form.Group>
                          ...
                          <Form.Control
                            ...
                            placeholder="https://linkedin.com/company/bpa"
                          />
                        </Form.Group>
                      </Col>
                    </>
                    ...
                    <>
                      <Col md={12}>
                        <Alert variant="info" className="py-2 text-sm">
                          <strong>Note:</strong> These messages are shown to customers on the public website when registration or payment is
                          unavailable. Make sure the support phone (Contact tab) is set so the call button appears.
                        </Alert>
                      </Col>
                      <Col md={12}>
                        <Form.Group>
                          <Form.Label className="fw-semibold">Registration Error Title</Form.Label>
                          <Form.Control value={f('registrationErrorTitle')} onChange={(e) => set('registrationErrorTitle', e.target.value)} />
                        </Form.Group>
                      </Col>
                      <Col md={12}>
                        <Form.Group>
            ...
            <div className="d-flex gap-2 mt-3">
              <Button type="submit" variant="primary" disabled={saving}>
                {saving ? (
                  ...
                  <>
                    <Icon icon="solar:diskette-bold-duotone" className="me-1" />
                    Save Settings
                  </>
                )}
              </Button>
