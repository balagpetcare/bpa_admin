...
import DiagnosticServiceCategoryBadge from './DiagnosticServiceCategoryBadge'
...
export default function DiagnosticServiceListContent() {
  ...
  async function handleDelete(id: string) {
    ...
    await mutate(() => diagnosticCenterServicesApi.remove(id), undefined)
    refetch()
  }

  async function handleToggleActive(item: DiagnosticCenterService) {
    await mutate(() => diagnosticCenterServicesApi.update(item.id, { isActive: !item.isActive }), undefined)
    refetch()
  }
  ...
  return (
    <div className="container-fluid">
      <PageHeader
        ...
        breadcrumbs={[{ label: 'Community Care Fund' }, { label: 'Diagnostic Center Services' }]}
        action={
