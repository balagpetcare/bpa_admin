        ...
        <Card className="text-center">
          <Card.Body className="py-5">
            ...
            <p className="text-muted mt-3 small">
              This will create the default BPA Community Care Partner Card Program with standard settings. You can edit them after creation.
            </p>
          </Card.Body>
        </Card>
      </>
        ...
        <Card.Body>
          <Form onSubmit={handleSubmit}>
            <Row className="g-3">
              <Col md={6}>
                <Form.Group>
                  <Form.Label>Program Name (EN)</Form.Label>
                  <Form.Control value={form.nameEn} onChange={(e) => setForm({ ...form, nameEn: e.target.value })} />
                </Form.Group>
              </Col>
              <Col md={6}>
                <Form.Group>
                  <Form.Label>Program Name (BN)</Form.Label>
                  <Form.Control value={form.nameBn} onChange={(e) => setForm({ ...form, nameBn: e.target.value })} />
                </Form.Group>
              </Col>
              <Col md={6}>
                <Form.Group>
              ...
              <Col md={6}>
                <Form.Group>
                  <Form.Label>Card Validity Label (e.g. &quot;5-Year Card Validity&quot;)</Form.Label>
                  <Form.Control value={form.cardValidityLabel} onChange={(e) => setForm({ ...form, cardValidityLabel: e.target.value })} />
                </Form.Group>
              </Col>

              <Col md={12}>
                <hr />
                <h5 className="text-(--bpa-navy)">Offer / Countdown Settings</h5>
              </Col>
              ...
              <Col md={12}>
                <Form.Group>
                  <Form.Check
                    type="switch"
                    label="Enable Launch Offer Pricing"
              ...
              <Col md={6}>
                <Form.Group>
                  ...
                  <Form.Control
                    ...
                    onChange={(e) => setForm({ ...form, offerStartAt: e.target.value })}
              ...
              <Col md={6}>
                <Form.Group>
                  ...
                  <Form.Control
                    ...
                    onChange={(e) => setForm({ ...form, offerEndAt: e.target.value })}
                    disabled={!form.offerEnabled}
                  />
                </Form.Group>
              </Col>
              <Col md={6}>
                <Form.Group>
                  <Form.Label>After Offer Expires</Form.Label>
                  <Form.Select value={form.priceAfterOffer} onChange={(e) => setForm({ ...form, priceAfterOffer: e.target.value })}>
              ...
              <Col md={6}>
                <Form.Group>
                  <Form.Label>Offer Banner (EN)</Form.Label>
                  <Form.Control
                    value={form.offerBannerEn}
                    onChange={(e) => setForm({ ...form, offerBannerEn: e.target.value })}
                    disabled={!form.offerEnabled}
                  />
                </Form.Group>
              </Col>
              <Col md={6}>
                <Form.Group>
                  <Form.Label>Offer Banner (BN)</Form.Label>
                  <Form.Control
                    value={form.offerBannerBn}
                    onChange={(e) => setForm({ ...form, offerBannerBn: e.target.value })}
                    disabled={!form.offerEnabled}
                  />
                </Form.Group>
              </Col>
