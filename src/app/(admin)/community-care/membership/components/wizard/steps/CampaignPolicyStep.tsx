...
export default function CampaignPolicyStep() {
  ...
  return (
    <Card>
      <Card.Header>
        <h5 className="mb-0">Policy & Informational Content</h5>
      </Card.Header>
      <Card.Body>
        <BilingualRichText
          labelEn="Eligibility (EN)"
          labelBn="Eligibility (BN)"
          valueEn={watch('eligibilityContentEn') ?? ''}
          valueBn={watch('eligibilityContentBn') ?? ''}
        ...
        />
        <BilingualRichText
          labelEn="How It Works (EN)"
          labelBn="How It Works (BN)"
          valueEn={watch('howItWorksContentEn') ?? ''}
          valueBn={watch('howItWorksContentBn') ?? ''}
        ...
        <BilingualRichText
          labelEn="Terms (EN)"
          labelBn="Terms (BN)"
          valueEn={watch('termsContentEn') ?? ''}
          valueBn={watch('termsContentBn') ?? ''}
        ...
        />
        <BilingualRichText
          labelEn="Refund Policy (EN)"
          labelBn="Refund Policy (BN)"
          valueEn={watch('refundPolicyEn') ?? ''}
          valueBn={watch('refundPolicyBn') ?? ''}
