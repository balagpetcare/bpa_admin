...
export default function CampaignSupportStep() {
  ...
  return (
    <Card>
      <Card.Header>
        <h5 className="mb-0">Organizer & Support</h5>
      </Card.Header>
      <Card.Body>
        <Row className="g-3">
          <Col md={6}>
            ...
            <Controller
              ...
              control={control}
              render={({ field }) => <Form.Control value={field.value ?? ''} onChange={field.onChange} />}
            />
          </Col>
          <Col md={6}>
            <Form.Label>Organizer (BN)</Form.Label>
            <Controller
              name="organizerNameBn"
              control={control}
              render={({ field }) => <Form.Control value={field.value ?? ''} onChange={field.onChange} />}
            />
          </Col>
          <Col md={4}>
            ...
            <Controller
              ...
              control={control}
              render={({ field }) => (
                <Form.Control value={field.value ?? ''} onChange={(e) => field.onChange(e.target.value.replace(/[^\d+]/g, ''))} />
              )}
            />
          </Col>
          <Col md={4}>
          ...
          <Col md={12}>
            ...
            <Controller
              name="supportAddress"
              control={control}
              render={({ field }) => <Form.Control as="textarea" rows={2} value={field.value ?? ''} onChange={field.onChange} />}
            />
          </Col>
        </Row>
      </Card.Body>
