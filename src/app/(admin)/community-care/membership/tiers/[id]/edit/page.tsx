        ...
        <Card.Body>
          <Form onSubmit={handleSubmit}>
            <Row className="g-3">
              ...
              <Col md={4}><Form.Group>
                <Form.Label>Launch Offer Price (৳) <span className="text-muted fw-normal">— shown during offer period</span></Form.Label>
                <Form.Control type="number" value={form.launchPriceBdt} onChange={(e) => setForm({ ...form, launchPriceBdt: Number(e.target.value) })} />
              </Form.Group></Col>
              <Col md={4}><Form.Group>
                <Form.Label>Regular Price (৳) <span className="text-muted fw-normal">— used after offer expires</span></Form.Label>
