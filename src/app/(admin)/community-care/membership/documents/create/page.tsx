            ...
            <Row className="g-3">
              <Col md={4}>
                <Form.Group>
                  ...
                  <Form.Select value={form.documentType} onChange={(e) => setForm({ ...form, documentType: e.target.value })}>
                    {DOC_TYPES.map((d) => (
              ...
              <Col md={4}>
                <Form.Group>
                  ...
                  <Form.Control value={form.titleEn} onChange={(e) => setForm({ ...form, titleEn: e.target.value })} required />
                </Form.Group>
              </Col>
              <Col md={4}>
                <Form.Group>
                  <Form.Label>Title (BN)</Form.Label>
                  <Form.Control value={form.titleBn} onChange={(e) => setForm({ ...form, titleBn: e.target.value })} required />
                </Form.Group>
              </Col>
              <Col md={6}>
                <Form.Group>
                  <Form.Label>Content (EN) — supports plain text</Form.Label>
                  <Form.Control as="textarea" rows={12} value={form.contentEn} onChange={(e) => setForm({ ...form, contentEn: e.target.value })} />
                </Form.Group>
              </Col>
              <Col md={6}>
                <Form.Group>
                  <Form.Label>Content (BN)</Form.Label>
                  <Form.Control as="textarea" rows={12} value={form.contentBn} onChange={(e) => setForm({ ...form, contentBn: e.target.value })} />
                </Form.Group>
              </Col>
              <Col md={12}>
                <Form.Group>
