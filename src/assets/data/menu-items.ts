...
export function getMenuItems(badges: MenuBadges = {}): MenuItemType[] {
  return [
    ...
    {
      key: 'membership-campaigns',
      label: 'Campaign Plans & Offers',
      icon: 'bx:bxs-megaphone',
      url: '/community-care/membership/campaigns',
    },
    {
    ...
    {
      key: 'membership-pricing-history',
      label: 'Pricing and Change History',
      icon: 'solar:history-bold-duotone',
      url: '/community-care/membership/plans',
    },
    {
    ...
    {
      key: 'membership-media-documents',
      label: 'Media & Documents',
      icon: 'bx:bxs-image',
      url: '/community-care/membership/media-documents',
    },
    {
      key: 'membership-applications',
      label: 'Applications',
      icon: 'solar:document-text-bold-duotone',
      url: '/community-care/membership/applications',
    },
    {
      key: 'membership-members',
      label: 'Member Entitlements',
      icon: 'solar:users-group-rounded-bold-duotone',
      url: '/community-care/membership/members',
    },
    {
      key: 'membership-covered-pets',
      label: 'Covered Pets',
      icon: 'solar:cat-bold-duotone',
      url: '/community-care/membership/covered-pets',
    },
    {
      key: 'membership-replacements',
      label: 'Replacement Requests',
      icon: 'solar:refresh-bold-duotone',
      url: '/community-care/membership/replacements',
    },
    {
      key: 'membership-service-usage',
      label: 'Service Usage',
      icon: 'solar:tablet-bold-duotone',
      url: '/community-care/membership/service-usage',
    },
    {
      key: 'membership-clinic-service',
      label: 'Clinic Service',
      icon: 'solar:health-bold-duotone',
      url: '/community-care/membership/clinic-service',
    },
    {
